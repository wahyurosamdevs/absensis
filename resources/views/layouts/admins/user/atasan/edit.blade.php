...
<div class="container" >
  <h3>edit Atasan</h3>
  <div class="row" >
    <form action="{{ route('atasan.update') }}" method="post">
      @csrf
      @foreach ($users as $user)
        <div class="col-sm-12" style="margin-top:10px;margin-bottom:10px">
          ...
          <div class="form-group">
            <input type="hidden" name="is_atasan" class="form-control" value="1" value="{{ $user->is_admin }}">
          </div>
          <div class="form-group">
          ...
          <a href="{{ route('atasan.index') }}" class="btn btn-danger">Back</a>
        </div>
      @endforeach
    </form>
  </div>
